...
export const articleBody        = "text-[#6e6e73] leading-[1.85] text-[0.95rem] max-w-6xl whitespace-pre-wrap"
...
// ─── Footer ───────────────────────────────────────────
export const footerClass        = "w-full bg-[#1d1d1f] py-12 px-6"
export const footerContainer    = "max-w-5xl mx-auto"
export const footerGrid         = "grid grid-cols-1 md:grid-cols-3 gap-12 mb-12"
export const footerSectionTitle = "text-lg font-semibold text-white mb-6 tracking-tight"
export const footerSectionText  = "text-[#a1a1a6] leading-relaxed mb-4"
export const footerLinkList     = "space-y-2"
export const footerLink         = "block text-[#a1a1a6] hover:text-[#0066cc] transition-colors text-sm"
export const socialLinks        = "flex space-x-4"
export const socialLink         = "w-9 h-9 bg-[#2d2d2f] rounded-xl flex items-center justify-center text-[#a1a1a6] hover:text-[#0066cc] hover:bg-[#3d3d40] transition-all duration-200"
export const copyrightSection   = "border-t border-[#2d2d2f] pt-8 text-center"
export const copyrightText      = "text-xs text-[#86868b] font-medium"
export const footerDivider      = "border-t border-[#2d2d2f] my-12"

export const fileInputClass =
  "w-full text-sm text-[#6e6e73] file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:font-semibold file:bg-[#0066cc] file:text-white hover:file:bg-[#004499] cursor-pointer mb-3"